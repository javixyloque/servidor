...
class SolicitanteBidireccional
{
    ...
    /**
     * @var \BecaBidireccional
     *
     * @ORM\ManyToOne(targetEntity="BecaBidireccional", inversedBy="solicitantes")
     * @ORM\JoinColumns({
     ...
     */
    public function getBeca(): \BecaBidireccional
    {
        return $this->beca;
    }
     ...
     */
    public function setBeca(\BecaBidireccional $beca): self
    {
        $this->beca = $beca;
