 ...
 */
final class Version20250509161957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE empleado (id INT AUTO_INCREMENT NOT NULL, puesto_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, dni VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, INDEX IDX_D9D9BF525035E9DA (puesto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
