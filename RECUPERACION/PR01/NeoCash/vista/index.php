...
<body>
    ...
    <form action="../scripts/registrarse.php" method="post" enctype="multipart/form-data">
        ...
        <input type="file" id="img_cliente" name="img_cliente" enctype="multipart/form-data"><br><br>
        ...
        <input type="password" name="confirmar_password" placeholder="******" required><br><br>
